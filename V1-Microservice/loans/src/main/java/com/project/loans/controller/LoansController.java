...
@Tag(
        name = "CRUD REST APIs for Loans in SecureTrust Bank",
        description = "CRUD REST APIs in SecureTrust Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get Java version details that is installed into loans microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
